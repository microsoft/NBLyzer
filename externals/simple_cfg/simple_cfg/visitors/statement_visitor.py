...
from ..translate.ast_helper import (
    generate_ast,
    get_call_names,
    get_call_names_as_string
)
from ..translate.module_definitions import (
...
class StmtVisitor(ast.NodeVisitor):
    ...
    def visit_If(self, node):
        test = self.append_node(CondNode(
            node.test,
            node,
        ...
        test.positive_nodes.append(body_connect_stmts.first_statement)
        ...
        cfg = ControlFlowNode(test, last_statements, break_statements=body_connect_stmts.break_statements)
        return cfg
    ...
    def visit_For(self, node):
        ...
        for_node = self.append_node(CondNode(
    ...
    def visit_While(self, node):
        ...
        while_node = self.append_node(CondNode(
